...
export const I2V_CATALOG: Record<string, ModelOpt[]> = {
  ...
  leonardo: [
    ...
    {
      value: "leo-vid:gemini-omni-flash",
      label: "Gemini Omni Flash (Leonardo · ~100 cr/s @ HD 720x1280)",
      cr: 500,
    },
    {
      value: "leo-vid:seedance-2.0-mini",
      label: "Seedance 2.0 Mini (Leonardo · ~74 cr/s @ Standard 496x864)",
      cr: 372,
    },
    {
      value: "leo-vid:grok-imagine-1.5",
      label: "Grok Imagine 1.5 (Leonardo · ~53 cr/s @ Standard 400x736)",
      cr: 263,
    },
    { value: "leo-vid:wan-2.6", label: "Wan 2.6 (Leonardo · ~35 cr/s @ HD 720x1280)", cr: 175 },
    {
      value: "leo-vid:veo-3.1-lite",
      label: "Veo 3.1 Lite (Leonardo · ~50 cr/s @ Quality 720x1280)",
      cr: 400,
    },
    {
      value: "leo-vid:veo-3.1-fast",
      label: "Veo 3.1 Fast (Leonardo · ~150 cr/s @ HD 720x1280)",
      cr: 1200,
    },
    // Other Models
    {
      value: "leo-vid:seedance-2.0",
      label: "Seedance 2.0 (Leonardo · ~141 cr/s @ Standard 496x864)",
      cr: 2109,
    },
    {
      value: "leo-vid:seedance-2.0-fast",
      label: "Seedance 2.0 Fast (Leonardo · ~113 cr/s @ Standard 496x864)",
      cr: 1687,
    },
    {
      value: "leo-vid:kling-o3-omni",
      label: "Kling Video O3 Omni (Leonardo · ~224 cr/s @ HD 720x1280)",
      cr: 3360,
    },
    {
      value: "leo-vid:kling-2.6",
      label: "Kling 2.6 (Leonardo · ~140 cr/s @ Full HD 1080x1920)",
      cr: 1400,
    },
  ],
};
...
const ROBONEO_QUALITY: Record<string, QualityOpt[]> = {
  ...
  "rn:seedance-2.0": [
    {
      value: "480p-10s-audio",
      label: "480p · 10s · audio",
      mult: 1,
      duration: 10,
      resolution: "480p",
      sound: "on",
  ...
  "rn:seedance-2.0-mini": [
    {
      value: "480p-12s-audio",
      label: "480p · 12s · audio",
      mult: 1,
      duration: 12,
      resolution: "480p",
      sound: "on",
