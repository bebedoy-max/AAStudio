...
export const SCENES: Scene[] = [
  {
    ...
    label: "Cafe",
    category: "daily",
    hint: "aesthetic cafe, latte art, natural light",
  },
  {
    key: "airport",
    label: "Airport",
    category: "travel",
    hint: "airport lounge, luggage, travel outfit",
  },
  {
    key: "library",
    label: "Library",
    category: "daily",
    hint: "quiet library, bookshelves, warm reading light",
  },
  {
    key: "mall",
    label: "Mall",
    category: "lifestyle",
    hint: "shopping mall, boutique, retail therapy",
  },
  ...
  { key: "gym", label: "Gym", category: "lifestyle", hint: "modern gym, active wear, workout" },
  {
    ...
    label: "Book Store",
    category: "daily",
    hint: "indie bookstore, browsing, cozy",
  },
  {
    key: "home",
    label: "Home",
    category: "daily",
    hint: "home interior, morning routine, cozy vibe",
  },
  { key: "office", label: "Office", category: "work", hint: "modern office, workspace, laptop" },
  {
    ...
    label: "Vacation",
    category: "travel",
    hint: "vacation resort, poolside, relax",
  },
  ...
  { key: "museum", label: "Museum", category: "social", hint: "museum, art gallery, thoughtful" },
  {
    ...
    label: "Restaurant",
    category: "social",
    hint: "fine dining, table setup, plated food",
  },
  {
    key: "festival",
    label: "Festival",
    category: "seasonal",
    hint: "music festival, crowd, night lights",
  },
  {
    key: "coffee",
    label: "Coffee Break",
    category: "daily",
    hint: "morning coffee, kitchen bar, mug",
  },
  ...
  { key: "shopping", label: "Shopping", category: "lifestyle", hint: "boutique shopping, bags" },
  {
    ...
    label: "Night Routine",
    category: "daily",
    hint: "skincare, bedroom, warm lamp",
  },
  {
    key: "morning-routine",
    label: "Morning Routine",
    category: "daily",
    hint: "morning, natural light, freshness",
  },
  { key: "weekend", label: "Weekend", category: "lifestyle", hint: "weekend vibes, chill, brunch" },
  {
    ...
    label: "Holiday",
    category: "seasonal",
    hint: "holiday season, decor, festive",
  },
  {
    key: "birthday",
    label: "Birthday",
    category: "social",
    hint: "birthday celebration, cake, candles",
  },
  {
    key: "random-daily",
    label: "Random Daily Life",
    category: "daily",
    hint: "spontaneous daily moment",
  },
];
