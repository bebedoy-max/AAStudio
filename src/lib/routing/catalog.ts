  ...
  },
  {
    ...
    providers: [
      ...
      },
      {
        id: "framia",
        name: "Framia",
        desc: "Canvas workflow via Framia — Nano Banana, Flux, Seedream, dsb.",
        models: [
      ...
      },
      {
        id: "firefly",
        name: "Adobe Firefly",
        desc: "Adobe Firefly web session token (Bearer IMS) di Token Manager → Firefly.",
        models: [
      ...
      },
      {
        id: "leonardo",
        name: "Leonardo.ai",
        desc: "Langsung ke app.leonardo.ai pakai Bearer JWT (Cognito) di Token Manager → Leonardo.",
        models: [
  ...
  },
  {
    ...
    providers: [
      ...
      },
      {
        id: "weavy",
        name: "Weavy",
        desc: "Video via token pool Weavy.",
        models: [
      ...
      },
      {
        id: "roboneo",
        name: "Roboneo",
        desc: "Kling I2V via Roboneo (Meitu gateway).",
        models: [
      ...
      },
      {
        id: "framia",
        name: "Framia",
        desc: "Canvas workflow video di Framia.",
        models: [
      ...
      },
      {
        id: "firefly",
        name: "Adobe Firefly",
        desc: "Firefly video (Veo via Adobe) — pakai Bearer token Firefly di Token Manager.",
        models: [
      ...
      },
      {
        id: "dola",
        name: "Dola",
        desc: "Video via sesi web dola.com (cookie session, ambil otomatis lewat extension). Support T2V & I2V.",
        models: [
      ...
      },
      {
        id: "leonardo",
        name: "Leonardo.ai",
        desc: "GraphQL /v1/graphql. Support I2V (image_reference) & T2V.",
        models: [
    ...
    providers: [
      {
        ...
        models: [{ name: "Kling Motion Control", cost: "~35 cr / 5s" }],
      },
      {
        id: "wavespeed",
        name: "Wavespeed",
        desc: "Kling Motion Control via Wavespeed API.",
        models: [
      ...
      },
      {
        id: "roboneo",
        name: "Roboneo",
        desc: "Kling Motion Control via Roboneo (Meitu). Hanya Kling V2.6 Std.",
        models: [{ name: "Kling V2.6 Standard", cost: "Gratis (kuota Roboneo)" }],
      },
      {
        id: "magnific",
        name: "Magnific",
        desc: "Kling Motion Control via api.magnific.com. Butuh Freepik/Magnific API key.",
        models: [{ name: "Kling Motion Transfer", cost: "~50 Freepik cr / 5s" }],
      },
      {
        id: "framia",
        name: "Framia",
        desc: "Motion Control via Framia canvas — Kling motion node.",
        models: [
