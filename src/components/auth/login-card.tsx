      ...
      <div className="relative min-w-0">
        ...
        <div className="mt-5 flex items-center justify-start gap-3 sm:gap-5 min-w-0">
          <div className="relative h-16 w-16 sm:h-[5.6rem] sm:w-[5.6rem] shrink-0">
            <div className="pointer-events-none absolute inset-[-10%] rounded-full border border-foreground/30 opacity-60 blur-[2px] animate-[logo-smoke_3.5s_ease-in-out_infinite]" />
            <div className="pointer-events-none absolute inset-[-30%] rounded-full bg-foreground/15 blur-xl animate-[logo-smoke_3s_ease-in-out_infinite]" />
            <img
          ...
          <div className="flex flex-col items-start leading-none min-w-0">
            <span className="font-display text-[2rem] sm:text-[2.7rem] font-black tracking-tight text-gradient">
              Creative
            </span>
            <span className="font-display text-[2rem] sm:text-[2.7rem] font-black tracking-tight text-gradient">
              Studio
