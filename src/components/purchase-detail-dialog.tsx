      ...
      >
        ...
        {purchase.status === "pending" && (
          <div className="mt-4 rounded-xl border border-amber-400/30 bg-amber-400/5 p-3 text-xs text-amber-200/90">
            Selesaikan pembayaran melalui metode yang dipilih. Status otomatis diperbarui setelah admin memverifikasi.
            Integrasi QRIS dinamis akan aktif setelah terhubung ke layanan pembayaran.
          </div>
        )}
