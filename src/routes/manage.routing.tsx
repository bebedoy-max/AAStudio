  ...
  },
  {
    ...
    providers: [
      ...
      },
      {
        id: "leonardo",
        name: "Leonardo.ai",
        desc: "Langsung ke app.leonardo.ai via GraphQL /v1/graphql (mutation Generate). Butuh Bearer JWT dari Token Manager → Leonardo. Support I2V (image_reference) & T2V. Angka credit = tampilan tombol Generate di app resmi.",
        models: [
          { name: "Gemini Omni Flash · 720p · 1–10s (T2V/I2V)",           cost: "~100 cr/s · 10s ≈ 1000" },
          { name: "Seedance 2.0 Mini · 720p · 1–15s (T2V/I2V)",           cost: "~160 cr/s · 15s ≈ 2400" },
          { name: "Grok Imagine 1.5 · up to 1072p · 1–15s (audio)",       cost: "~165 cr/s · 15s HD ≈ 2475" },
          { name: "Wan 2.6 · 720p/1080p · 5/10/15s (audio)",              cost: "~35 cr/s · 15s HD ≈ 525" },
          { name: "Veo 3.1 Lite · 720p/1080p · 4/6/8s (audio)",           cost: "~50 cr/s · 8s Quality ≈ 400" },
          { name: "Veo 3.1 Fast · 720p/1080p/4K · 4/6/8s (audio)",        cost: "~150 cr/s · 8s HD ≈ 1200" },
          { name: "Seedance 2.0 · 480/720/1080/4K · 1–15s",               cost: "~140 cr/s · 15s Std ≈ 2109" },
          { name: "Seedance 2.0 Fast · 480/720 · 1–15s",                  cost: "~112 cr/s · 15s Std ≈ 1687" },
          { name: "Kling Video O3 Omni · 720/1080/4K · 1–15s (audio)",    cost: "~224 cr/s · 15s HD ≈ 3360" },
          { name: "Kling 2.6 · Full HD 1080p · 5/10s (audio)",            cost: "~140 cr/s · 10s ≈ 1400" },
        ],
      },
    ],
  },
