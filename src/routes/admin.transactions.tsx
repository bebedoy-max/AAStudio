...
export const Route = createFileRoute("/admin/transactions")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Riwayat penjualan & transfer token per provider, per user.",
      },
    ],
  }),
  component: Page,
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      {Object.keys(byProvider).length > 0 && (
        <Card>
          <div className="p-4 border-b border-border/60 font-display text-lg">
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {rows.map((r) => (
                  <tr
                    key={r.id}
                    className="border-b border-border/40 hover:bg-sidebar-accent/20 align-top"
                  >
