...
import { I2V_CATALOG, RATIOS, qualityOptsFor, readRoutedVideoProvider } from "@/lib/providers/video-catalog";
  ...
  const generate = async () => {
    ...
    try {
      ...
      const url = await generateI2V({
        provider: provider as "weavy" | "wavespeed" | "magnific" | "roboneo" | "framia" | "leonardo" | "firefly" | "dola",
        modelKey: model,
        imageFile: imgFile,
        ratio,
